...
Review [Solving the Employee Class Problem](https://mediaplayer.pearsoncmg.com/assets/gaddis_cpp10e_1303_Employee_Class_Problem) VideoNote. You will see the output you should have for this programming challenge as well as the code. 